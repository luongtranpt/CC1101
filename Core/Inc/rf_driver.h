...
#define READ_TXFIFO(ADDR) ADDR
#define READ_TXFIFO_BURST(ADDR) ADDR | 0x40
/*---------------------------[END R/W offsets]--------------------------------*/
...
#define RSSI_OFFSET      0x4E  //dec = 74
...
uint8_t rf_check();
void rf_reset();
uint8_t rf_begin(SPI_TypeDef* SPIx, MODULATION_TypeDef mode, ISMBAND_TypeDef ism_band,  GPIO_TypeDef* cs_port, uint16_t cs_pin, uint16_t gdo0_pin);
